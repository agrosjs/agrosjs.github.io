[@agros/utils](../index.md) / RequireFromStringOptions
...
[require-from-string.ts:9](https://github.com/agrosjs/agros/blob/1cfd777/packages/agros-utils/src/require-from-string.ts#L9)
...
[require-from-string.ts:14](https://github.com/agrosjs/agros/blob/1cfd777/packages/agros-utils/src/require-from-string.ts#L14)
