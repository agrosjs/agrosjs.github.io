[@agros/tools](../index.md) / EntryTailCodeData
...
[packages/agros-tools/src/platform.interface.ts:23](https://github.com/agrosjs/agros/blob/b947880/packages/agros-tools/src/platform.interface.ts#L23)
