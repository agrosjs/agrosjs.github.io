...
[project-config-parser.ts:8](https://github.com/agrosjs/agros/blob/308fc0e/packages/agros-config/src/project-config-parser.ts#L8)
...
[project-config-parser.ts:9](https://github.com/agrosjs/agros/blob/308fc0e/packages/agros-config/src/project-config-parser.ts#L9)
...
[project-config-parser.ts:10](https://github.com/agrosjs/agros/blob/308fc0e/packages/agros-config/src/project-config-parser.ts#L10)
...
[project-config-parser.ts:7](https://github.com/agrosjs/agros/blob/308fc0e/packages/agros-config/src/project-config-parser.ts#L7)
